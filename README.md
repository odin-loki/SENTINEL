...
<p align="center">
  <strong>C++23 Â· Qt 6 Â· SQLite Â· 333 passing tests</strong>
</p>
...
â””â”€â”€ tests/
    â”œâ”€â”€ CMakeLists.txt          # 333 test targets
...
SENTINEL has **333 test targets** covering every pipeline stage. Tests are written with Qt Test and run via CTest.
