...
<p align="center">
  <strong>C++23 Â· Qt 6 Â· SQLite Â· 381 passing tests</strong>
</p>
...
â””â”€â”€ tests/
    â”œâ”€â”€ CMakeLists.txt          # 381 test targets
...
SENTINEL has **381 test targets** covering every pipeline stage. Tests are written with Qt Test and run via CTest.
